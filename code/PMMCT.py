...
TestData1 = sio.loadmat(Testalphafile1)['remaining_data']
TestAlpha1 = TestData1[:, :, 0]
TestSEM1 = TestData1[:, :, 1]

Testalphafile0 = "neg_Test_x.mat"
...
x_train1 = TrainAlpha1['subset_data']  # (1174, 500)

TrainAlphafile0 = "neg_Train_x.mat"
